...
const VendorSettings = () => {
    ...
    const fetchVendorData = async () => {
        await apiInstance.get(`vendor/shop-settings/${userData?.vendor_id}/`)
        .then((res) => {
                ...
                <div className="col-md-9 col-lg-10 main mt-4">
                    <div className="container">
                        ...
                        <div className="row gutters-sm shadow p-4 rounded">
                            <h3 className="fw-bold mb-4">Shop settings</h3>
                                    ...
                                    <div className="card mb-3">
                                        ...
                                        >
                                            ...
                                            <div className="col-lg-12 mb-2">
                                                ...
                                                <textarea name="about" value={profileData?.about} onChange={handleInputChange} id="" cols="30" rows="3" className='form-control'/>
                                            </div>
