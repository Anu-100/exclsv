        ...
        <div className="col-md-3 col-lg-2 sidebar-offcanvas bg-dark navbar-dark" id="sidebar" role="navigation" >
            <ul className="nav nav-pills flex-column mb-auto nav flex-column pl-1 pt-2">
                <li className="mb-3">
                    ...
                    className={isActiveLink(location.pathname, '/vendor/dashboard') ? "nav-link text-white active": "nav-link text-white"}
                    >
                ...
                <li className="mb-3">
                    ...
                    className={isActiveLink(location.pathname, '/vendor/products') ? "nav-link text-white active": "nav-link text-white"}
                    >
                        <i className="fas fa-table-cells" /> Products{" "}
                    </Link>
                </li>
                <li className="mb-3">
                    ...
                    >
                        <i className="fas fa-cart-shopping" /> Orders{" "}
                    </Link>
                </li>
                <li className="mb-3">
                    ...
                    >
                        <i className="fas fa-indian-rupee-sign" /> Earning{" "}
                    </Link>
                </li>
                <li className="mb-3">
                ...
                <li className="mb-3">
                    <Link to="/vendor/product/new" className={isActiveLink(location.pathname, '/vendor/product/new') ? "nav-link text-white active": "nav-link text-white"}>
                        <i className="fas fa-circle-plus" /> Add Product{" "}
                    </Link>
                </li>
                ...
                <li className="mb-3">
                    <Link to={`/vendor/coupon`} className={isActiveLink(location.pathname, '/vendor/coupon') ? "nav-link text-white active": "nav-link text-white"}>
                        <i className="fas fa-tag" /> Coupon &amp; Discount{" "}
                    </Link>
                </li>
