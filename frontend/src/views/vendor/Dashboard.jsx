...
const Dashboard = () => {
    ...
    const fetchChartData = async () => {
        try {
            ...
            const product_chart_response = await apiInstance.get(`vendor-products-chart/${userData?.vendor_id}/`)
            setProductChartData(product_chart_response.data);
        } catch (error) {
            console.log(error);
        }
    }
            ...
            <div className="row row-offcanvas row-offcanvas-left h-100">
                ...
                <div className="row mb-3">
                    ...
                    <div className="card card-inverse card-success">
                        ...
                        <h3 className="display-6">{stats?.products}</h3>
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 mb-2">
                    <div className="card card-inverse card-danger">
                        ...
                        <h3 className="display-6">{stats?.orders}</h3>
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 mb-2">
                    <div className="card card-inverse card-warning">
                        ...
                        <h3 className="display-6">₹{stats?.revenue}</h3>
                        </div>
                    </div>
                    </div>
                </div>
